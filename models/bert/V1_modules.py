...
class MultiHead_Attention_Lattice_rel_save_gpumm(nn.Module):
    def __init__(self, hidden_size, num_heads, pe,
        ...
        self.u = nn.Parameter(torch.randn(self.num_heads, self.per_head_size))

        self.v = nn.Parameter(torch.randn(self.num_heads, self.per_head_size))
    ...
    def forward(self,key, query, value, seq_len, lex_num, pos_s,pos_e,rel_pos_embedding):
        ...
        #print("query_and_u_for_c", torch.any(query_and_u_for_c.isnan()))
        #print(query_and_u_for_c)
        #print("key", torch.any(key.isnan()))
        #print(key)
        ...
        #print("A_C", torch.any(A_C.isnan()))

        #print("B_D", B_D)

        #print("B_D", torch.any(B_D.isnan()))
    ...
    def forward(self, inp, seq_len, lex_num=0,pos_s=None,pos_e=None,rel_pos_embedding=None):
        ...
        if self.lattice:
            if self.relative_position:
                ...
                #print("inner encoder layer:", output)
